...
// 🔹 Tableau de textes à injecter (copier-coller tes 200-300 lignes)
const textBlocks = [
...
/**
 * Injection des textes dans Pinecone avec metadata
 */
async function injectTexts() {
  for (let i = 0; i < textBlocks.length; i++) {
    ...
    const metadata = {
      ...
      source: "CGA" // tu peux changer la source pour chaque texte
    };
